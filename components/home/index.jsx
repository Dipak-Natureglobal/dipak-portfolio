...
const HomePage = () => {
  return (
    <section className="min-h-[80vh] xl:my-28 mt-36 ">
        ...
        <div className=" flex flex-col  xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="order-1 xl:order-none mb-8 xl:mb-0">
            <Image
              ...
              alt="logo"
              className="rounded-xl mb-2  shadow-2xl xl:dark:shadow-[#ADFF2F]/30 dark:shadow-[#ADFF2F]/60 shadow-[#22c55e]/60 "
            />
      ...
      <div className="w-full  flex items-center justify-center bg-gray-100 dark:bg-primary px-6 py-16">
        <div className="text-left max-w-6xl w-full bg-gray-100 dark:bg-[#27272c] rounded-2xl shadow-2xl p-8 md:p-16  border dark:border-[#ADFF2F]/40 border-[#22c55e]/40">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-10 text-[#22c55e] dark:text-[#ADFF2F] text-center">
            🚀 How to Become a Good Coder in the Modern Era
          </h2>
          <p className="text-left text-lg md:text-xl dark:text-white/80 text-black/70 mb-12 max-w-4xl mx-auto leading-relaxed ">
            Writing code that works is just the start. To be a great coder, write <span className="font-semibold text-[#22c55e] dark:text-[#ADFF2F]">optimized, clean, and efficient</span> code that scales and solves real problems.<br /><br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <a
              ...
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">Cursor</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                AI-first code editor that understands your codebase and helps you build faster.
              </p>
            </a>
            ...
            <a
              ...
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">v0</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                AI pair programmer that understands your requests in plain English.
              </p>
            </a>
            ...
            <a
              ...
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">Lovable</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                AI-powered collaboration and project generation tool.
              </p>
            </a>
            ...
            <a
              ...
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">Firebase Studio</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                Visual AI platform to build and manage Firebase apps easily.
              </p>
            </a>
            ...
            <a
              ...
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">GitHub Copilot</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                AI assistant that suggests code completions and helps you write better code.
              </p>
            </a>
            <a
              href="https://von.dev/chats/new"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 bg-[#22c55e]/10 dark:bg-[#ADFF2F]/10 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
            >
              <h3 className="text-[#22c55e] dark:text-[#ADFF2F] font-bold text-xl mb-2">Von Full Stack
                Engineer</h3>
              <p className="text-black/70 dark:text-white/70 text-sm">
                Built for the dreamers, builders, and believers.
                Von is your AI tech team here to turn your boldest ideas into reality.
              </p>
            </a>
          </div>

          <p className="text-left text-lg dark:text-white/80 text-black/70 max-w-4xl mx-auto mt-14 ">
            The future belongs to those who adapt. Many more powerful AI tools are available — <span className="font-semibold text-[#22c55e] dark:text-[#ADFF2F]">explore and grow.</span><br /><br />
