...
const HireMe = () => {
  return (
    ...
    >
      <div className="container mx-auto px-4 xl:mt-16 mt-20">
        {/* Hero Section */}
        <motion.div
        ...
        >
          ...
          <p className="text-xl dark:text-gray-300 text-gray-600 max-w-5xl mx-auto leading-relaxed">
        ...
        <div className="grid xl:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="sticky top-8">
              <h2 className="text-4xl font-bold mb-8 dark:text-white text-black/70">
                Why Choose
              ...
              <div className="space-y-6 mb-12">
                {info.map((item, index) => (
                  <motion.div
                    ...
                    className="group p-6 rounded-2xl dark:bg-[#27272c] bg-white shadow-lg hover:shadow-xl transition-all duration-300 border dark:border-gray-700 border-gray-200 hover:scale-105"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs px-3 py-1 rounded-full bg-gradient-to-r from-[#22c55e] to-[#16a34a] dark:from-[#ADFF2F] dark:to-[#22c55e] text-black/70 font-medium">
                            {item.highlight}
                          </span>
                        </div>
